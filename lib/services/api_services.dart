...
import 'package:chatgptproject/constants/api_constants.dart';
...
class ApiService {
  ...
  //     if(jsonResponse["choices"].toString().length>0){
  //        //print("jsonResponse[choices] text ${jsonResponse["choices"][0]["text"]}");
  //      chatList=List.generate(jsonResponse["choices"].toString().length, (index) =>
